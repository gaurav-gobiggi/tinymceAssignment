var app = angular.module('textEditorApp', ['ui.tinymce']);
app.controller('textEditorController', function($scope, $http, $sce) {
    $scope.editText = {
        'text1': 'Click here to edit abc!',
    ...
    $scope.updateHtml = function() {
        console.log('test', $scope.editText);
        ctrl.tinymceHtml = $sce.trustAsHtml($scope.editText.text1);
    };
    $scope.content = function() {
        ...
        // $scope.editText.text4 = tinyMCE.get('myeditablediv3').getBody().textConten,t;
